...
## Si Liang Lei's remarks

### citations / worked with / received help from
* Brainstormed with Nahi Khan about the different parts of the recursive solution to the problem.
* Worked with Samuel Fang to gain a better understanding of the memory diagrams.
